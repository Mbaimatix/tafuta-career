...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://tafutacareer.com',
    images: [{ url: 'https://tafutacareer.com/og-image.png', width: 1200, height: 630, alt: 'TAFUTA CAREER' }],
    locale: 'en_KE',
  },
  twitter: {
    ...
    images: ['https://tafutacareer.com/og-image.png'],
  },
